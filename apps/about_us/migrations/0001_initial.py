    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(default='icons', editable=False, max_length=200)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('contentblock_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='about_us.contentblock')),
                ('type', models.CharField(auto_created=True, default='images', editable=False, max_length=10)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(default='slider', editable=False, max_length=200)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sub_title_ru', models.CharField(blank=True, max_length=50, null=True)),
                ('order', models.PositiveIntegerField(default=0, verbose_name='Порядок')),
